...
public class View extends JFrame {
	...
	View(Controller c){
		...
		symList.setBounds(20, 269, 267, 181);
		allOut.add(symList);
		...
		test.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Statement s=new CompoundStatement(new AssignStatement("v",new NewExpresion(10)),new CompoundStatement(new PrintStatement(new HeapReadingExpresion("v")),new AssignStatement("a",new ConstantExpresion(2))));
				JFrame rame=new JFrame("Info");
				JOptionPane.showMessageDialog(rame,"Program introduced");
			}
		});
	...
	private Statement ChooseStatement()
	 {
		 JFrame jframe = new JFrame();
			Object[] possibilities = {"Assignment", "Print", "If","Compound"};
